# ASP.NET Core Web - DWG to SVG Converter (Full API)

A web-based DWG to SVG converter with file upload, full API settings panel, and download links.
...
Open browser to `http://localhost:9878`
